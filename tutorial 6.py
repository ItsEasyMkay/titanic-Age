...
class testAge(unittest.TestCase):
     ...
     def test_averageAge6(self):
            self.assertEqual(age_averageAgefunction(['0','1','2','3','20']),6.5)
     
     def test_averageAge7(self):
            self.assertEqual(age_averageAgefunction([10,'1','2','3','20']),7.2)
